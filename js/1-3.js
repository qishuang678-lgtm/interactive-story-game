document.addEventListener("DOMContentLoaded", () => {
    // 对话数据
    const dialogues = [
        { name: "那年追风", text: "欸，KO，你还好吗，怎么不动了？", position: "left", image: "../images/吕骐豪抠像.png" },
        { name: "朋友", text: "（声音变慌）：“哎？我在动鼠标啊！怎么没反应了？”", position: "right", image: "../images/朋友.png" },
        { name: "那年追风", text: "你的KO怎么自己换阵营了？坏了，怎么冲我来了？？？", position: "left", image: "../images/吕骐豪抠像.png" },
    ];
